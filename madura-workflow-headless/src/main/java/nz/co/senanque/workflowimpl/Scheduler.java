...
public class Scheduler {
	...
	@Scheduled(fixedDelayString="${nz.co.senanque.workflowimpl.Scheduler.activeProcesses:10000}")
	public void activeProcesses() {
		m_executor.activeProcesses();
	}
	@Scheduled(fixedDelayString="${nz.co.senanque.workflowimpl.Scheduler.deferredEvents:10000}")
	public void deferredEvents() {
		m_executor.deferredEvents();
	}
	@Scheduled(fixedDelayString="${nz.co.senanque.workflowimpl.Scheduler.clearDeferredEvents:60000}")
