 ...
 * generated in the nz.co.senanque.ws.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _Reverse_QNAME = new QName("http://server.ws.senanque.co.nz/", "reverse");
    private final static QName _ReverseResponse_QNAME = new QName("http://server.ws.senanque.co.nz/", "reverseResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: nz.co.senanque.ws.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ws.senanque.co.nz/", name = "reverse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ws.senanque.co.nz/", name = "reverseResponse")
