...
public class ParsePackageTest6 {

	private static final Logger log = LoggerFactory
			.getLogger(ParsePackageTest6.class);
	@Autowired
	...
	public void testParse6() throws Exception {
		...
		ParserSource parserSource = new InputStreamParserSource(m_processes, 2000);
		...
		parsePackage.setDebug(false);
		parsePackage.parse(textProvider); // should throw an exception here.
		assertEquals(21, workflowManager.getMainProcesses().size());
		assertEquals(54, workflowManager.getAllProcesses().size());
