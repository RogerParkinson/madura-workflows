...
public class ParsePackageTest3 {

	private static final Logger log = LoggerFactory
			.getLogger(ParsePackageTest3.class);
	@Autowired
	...
	public void testParse3() throws Exception {
		...
		assertEquals(1, workflowManager.getMainProcesses().size());
		assertEquals(7, workflowManager.getAllProcesses().size());
