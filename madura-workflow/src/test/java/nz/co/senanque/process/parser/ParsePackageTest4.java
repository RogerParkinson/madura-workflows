...
public class ParsePackageTest4 {

	private static final Logger log = LoggerFactory
			.getLogger(ParsePackageTest4.class);
	@Autowired
	...
	public void testParse4() throws Exception {
		...
		assertEquals(3, workflowManager.getMainProcesses().size());
		assertEquals(3, workflowManager.getAllProcesses().size());
