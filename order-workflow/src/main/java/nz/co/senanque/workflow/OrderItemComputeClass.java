...
import nz.co.senanque.workflow.orderinstances.OrderItem;
...
public class OrderItemComputeClass implements ComputeType<OrderItem> {
	...
	private static final Logger log = LoggerFactory
			.getLogger(OrderItemComputeClass.class);
	public void execute(ProcessInstance processInstance, OrderItem context, Map<String, String> map) {
